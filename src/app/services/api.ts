...
const SAMPLE_MENU: MenuItem[] = [
    ...
    { id: 2, name: "Iced Caramel Macchiato", description: "Freshly pulled espresso with creamy milk and rich buttery caramel sauce over ice.", price: 4.80, category: "Drinks", imageUrl: "https://images.unsplash.com/photo-1595981267035-7b04ca84a810?q=80&w=800&auto=format&fit=crop", isAvailable: true },
    ...
    { id: 5, name: "Signature Hot Chocolate", description: "70% Dark Belgian chocolate melted into silky textured milk with toasted marshmallows.", price: 5.20, category: "Drinks", imageUrl: "https://images.unsplash.com/photo-1544145945-f904253d0c71?q=80&w=800&auto=format&fit=crop", isAvailable: true },
